...
class LPLHAgent:
    ...
    def _retrieve_experiences_for_prompt(self, query: str) -> str:
        ...
        records = self._merge_experience_records(
            achievement_records + death_records + general_records
        )
    ...
    def _select_diverse_experiences(self, records: list[dict],
        ...
        # Slot 1: nearby achievement that has not already been earned this epoch.
        ...
        # Slot 2: relevant warning/death memory.
        for record in records:
        ...
        # Slot 3: local object-anchored mechanics, then object-anchored clues.
        ...
        # Filler: only novel routes, then best remaining non-route hit. This is a
        # cap, not a quota, so no padding with redundant map facts.
        for record in records:
            if len(selected) >= top_k:
                break
