...
class LPLHAgent:
            ...
            try:
                ...
                if event_key and self.experience_lib.event_seen(event_key):
                    ...
                    if is_death:
                        ...
                        if goal_transition:
                            situation_detail.setdefault(
                                "goal_transitions", []
                            ).append(goal_transition)
    ...
    def _handle_duplicate_death_goal(self, event_key: str,
                                     hazard_location: str,
        ...
        if goal and not parsed.get("preparable"):
            ...
            transition["status"] = "declined"
        elif goal and self._inventory_matches_requirements(
            inventory,
            parsed.get("requires", []),
        ):
    ...
    def _maybe_handle_repeated_death_goal(self, duplicate_death: bool,
        ...
        """Expose the repeated-death threshold explicitly for focused tests."""
        if not duplicate_death:
            return {}, {}
        return self._handle_duplicate_death_goal(**kwargs)
    ...
    def _inventory_matches_requirements(self, inventory: list,
