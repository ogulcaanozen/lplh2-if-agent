# LPLH2 Memory Grounding and Visit-Count Patch

Experimental LPLH2 framework for text-based interactive fiction agents.

This snapshot is `lplh2_memory_grounding_visitcount_patch_2026-07-16`. It is
an experimental child of `lplh2_location_refinement_patch_2026-07-14`; older
version folders and the repository's current main marker remain unchanged.
