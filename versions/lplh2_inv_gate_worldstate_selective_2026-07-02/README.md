...
This snapshot is `lplh2_inv_gate_worldstate_selective_2026-07-02`: it starts
from the higher-scoring inventory-gate baseline and selectively adds
world-state reliability fixes, dedicated inventory reconciliation, newer
logging/timing, and action-space context.

It intentionally does not include the dynamic situation manager, active
planning, or BFS navigation experiments.
