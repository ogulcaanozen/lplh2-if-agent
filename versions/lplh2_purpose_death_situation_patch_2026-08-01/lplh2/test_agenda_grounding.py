...
class AgendaGroundingTests(unittest.TestCase):
        ...
        ideas = [
            {
                ...
                "preparation_relation": "A separate tool could help overcome the blocked access.",
            ...
            },
            {
                ...
                "preparation_relation": "The lantern can provide light in the dark area.",
    ...
    def test_resource_named_in_situation_is_not_rejected(self):
        ...
        agenda = brainstormer.build_agenda(
            [{
                ...
                "preparation_relation": "The key is the stated resource required by the door.",
    ...
    def test_preparation_without_functional_relation_is_demoted(self):
        brainstormer = AffordanceBrainstormer()
        agenda = brainstormer.build_agenda(
            [{
                "location": "Room",
                "situation": "a hazardous passage is ahead",
                "target_object": "coin",
                "preparation_for": "hazardous passage",
                "preparation_resource": "coin",
                "commands_to_try": ["take coin"],
            }],
            visible_objects=["coin"],
        )
        self.assertNotIn("agenda_type", agenda[0])
        self.assertEqual(
            brainstormer.last_preparation_validations[0]["reason"],
            "missing_preparation_relation",
        )
            ...
            [
                {
                    ...
                    "preparation_resource": "lantern",
                    "preparation_relation": "The lantern can provide portable light beyond the door.",
