...
Captures structured experience summaries, tracks neutral-event dedup state,
and retrieves relevant past experiences via the configured vector backend.
"""
...
class ExperienceLib:
    ...
    def __init__(self, persist_dir: str = None, event_index_dir: str = None):
        ...
        self._event_index = None  # persistent neutral-event dedup index
    ...
    def reset(self):
        ...
        # Don't reset the neutral-event index either; it prevents duplicate
        # neutral summaries across epochs in the same experiment.
    ...
    def _load_event_index(self):
        ...
        try:
            ...
            logger.warning(f"Failed to load neutral event index: {e}")
            self._event_index = {}
    ...
    def _save_event_index(self):
        ...
        data = {
            "version": 1,
            "description": "Neutral-state experience event keys already summarized.",
        ...
        try:
            ...
            logger.warning(f"Failed to save neutral event index: {e}")

    def retrieve_relevant_structured(self, query: str, top_k: int = None) -> list[dict]:
        ...
        return [
            ...
            for exp in self.experiences[-top_k:]
        ]
