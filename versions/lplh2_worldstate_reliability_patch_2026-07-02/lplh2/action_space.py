...
class ActionSpace:
    ...
    def to_prompt_string(self, current_objects: list) -> str:
        ...
        output.append(
            "No generated verb-object command cross-product is shown. "
            "Use these learned templates only as syntax reference; rely on the "
            "affordance agenda and current observation for concrete object commands."
        )
